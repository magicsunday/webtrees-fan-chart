...
const PNG_GOLDEN = path.join(GOLDENS_DIR, "fan-chart-7gen.png");
const SVG_GOLDEN = path.join(GOLDENS_DIR, "fan-chart-7gen.svg");
const FIXTURE = path.join(__dirname, "fixtures", "fan-chart-export-7gen.html");
...
describe("fan chart export regressions (7 generations)", () => {
