(function (global, factory) {
    ...
    function transformer() {
      ...
      scale.invert = function(y) {
        return clamp(untransform((input || (input = piecewise$$1(range$$1, domain.map(transform), number)))(y)));
      };
    ...
    class Geometry
    {
        ...
        get scale()
        {
            return linear$2().range([this.startPi, this.endPi]);
        }
    ...
    class Text
    {
        ...
        {
            let personId = select(label.node().parentNode).attr("id");
        ...
        transformOuterText(label, data)
        {
            ...
            textElements.each(function (ignore, i) {
                ...
                if (data.depth === 0) {
                    select(this).attr("dy", offsetRotate + "em");
                } else {
    ...
    class Person
    {
         ...
         * @param {Object}    d
         */
        constructor(config, options, hierarchy$$1, person, d)
        {
            this._config    = config;
            this._options   = options;
            this._hierarchy = hierarchy$$1;
            this._geometry  = new Geometry(options);
    ...
    class Update
    {
         ...
         * @param {Hierarchy} hierarchy
         */
        constructor(config, options, hierarchy$$1)
        {
            this._config    = config;
            this._options   = options;
            this._hierarchy = hierarchy$$1;
    ...
    class Chart
    {
        ...
        constructor(selector, options)
        {
            ...
            // Parent container
            this._config.parent = select(selector);
        ...
        init()
        {
            ...
            let hierarchy$$1 = new Hierarchy(this._options.data, this._options);
            let arc$$1       = new Arc(this._config, this._options, hierarchy$$1);
        ...
        doReset()
        {
            this._config.svg
                .transition()
                .duration(750)
                .call(this._zoom.get().transform, identity$5);
        }
    }
