		...
		<fieldset class="form-group">
			<div class="row">
				...
				<div class="col-sm-9 wt-page-options-value">
					...
					<input class="btn btn-primary" type="reset" value="<?= I18N::translate('reset') ?>">
				</div>
			</div>
		</fieldset>
	</form>
...
<script type="text/javascript" src="modules_v3/ancestral-fan-chart/js/packages/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
<script type="text/javascript" src="modules_v3/ancestral-fan-chart/js/packages/d3.v4.custom.min.js"></script>
<script type="text/javascript" src="modules_v3/ancestral-fan-chart/js/ancestral-fan-chart.js"></script>
